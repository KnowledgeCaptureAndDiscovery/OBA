...
import static org.openapitools.codegen.config.CodegenConfigurator.LOGGER;
...
public class ObaUtils {
    ...
    public static void unZipIt(String resourceName, String outputFolder) {
        ...
        try {
            ...
            LOGGER.severe("Error while extracting the reosurces: " + ex.getMessage());
        }
    ...
    public static void copy(InputStream is, File dest) throws Exception {
        ...
        try {
            ...
            LOGGER.severe("Error while extracting the reosurces: " + e.getMessage());
            throw e;
        } finally {
            if (is != null)
                is.close();
